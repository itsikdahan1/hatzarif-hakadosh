  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 pt-12">
        <button 
          onClick={onBack} 
          className="flex items-center gap-2 text-charcoal/40 font-bold mb-12 hover:text-charcoal transition-colors group"
        >
        ...
        {/* Vision & History Cards */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-32">
          <motion.div 
            whileHover={{ y: -5 }}
            className="bg-white p-12 rounded-[3.5rem] border border-charcoal/5 shadow-xl relative overflow-hidden"
          >
          ...
          <motion.div 
            whileHover={{ y: -5 }}
            className="bg-charcoal p-12 rounded-[3.5rem] border border-white/10 shadow-2xl relative overflow-hidden text-white"
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {(SYNAGOGUE_INFO as any).team.map((member: any, idx: number) => (
              ...
              >
                ...
                <p className="text-charcoal/50 text-center leading-relaxed font-serif italic text-sm">
                  "{member.bio}"
                </p>
              </motion.div>
            ))}
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="relative">
              <div className="aspect-square rounded-[3rem] overflow-hidden rotate-2 shadow-2xl">
                <img 
                  src="https://images.unsplash.com/photo-1445013517791-41b05179856d?auto=format&fit=crop&q=80&w=800" 
                  alt="Synagogue Internal" 
