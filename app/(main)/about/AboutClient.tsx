        ...
        <div className="max-w-7xl mx-auto px-4 pt-12">
          ...
          <div className="text-center mb-24 relative">
            <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ duration: 0.8 }}>
              <h1 className="text-5xl md:text-8xl font-serif font-bold text-charcoal mb-6 leading-tight">
                הסיפור של <span className="text-gold-warm">הצריף</span>
              </h1>
              <div className="w-32 h-2 bg-gold-warm mx-auto mb-10 rounded-full" />
              <p className="text-xl md:text-2xl text-charcoal/60 max-w-3xl mx-auto leading-relaxed font-serif italic">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-32">
            <motion.div whileHover={{ y: -5 }} className="bg-white p-12 rounded-[3.5rem] border border-charcoal/5 shadow-xl relative overflow-hidden">
            ...
            <motion.div whileHover={{ y: -5 }} className="bg-charcoal p-12 rounded-[3.5rem] border border-white/10 shadow-2xl relative overflow-hidden text-white">
          ...
          <div className="mb-32">
            <div className="flex items-center gap-6 mb-16">
              <h2 className="text-4xl md:text-5xl font-bold text-charcoal whitespace-nowrap">ההנהגה שלנו</h2>
              ...
              {(SYNAGOGUE_INFO as any).team.map((member: any, idx: number) => (
                <motion.div key={idx} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: idx * 0.2 }} className="group">
                  <div className="relative mb-8">
                    <div className="aspect-[4/5] rounded-[3rem] overflow-hidden grayscale group-hover:grayscale-0 transition-all duration-700 shadow-xl group-hover:shadow-2xl">
                      <img src={member.image} alt={member.name} className="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-700" referrerPolicy="no-referrer" />
                    </div>
          ...
          <div className="bg-white rounded-[4rem] p-12 md:p-24 shadow-2xl border border-charcoal/5 relative overflow-hidden mb-32">
            ...
            <div className="grid lg:grid-cols-2 gap-20 items-center">
              <div>
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <h2 className="text-4xl font-bold text-charcoal">בית של שקיפות ואמינות</h2>
                </div>
                <p className="text-xl text-charcoal/60 leading-relaxed mb-12 border-r-4 border-gold-warm/30 pr-8">
              ...
              <div className="relative">
                <div className="aspect-square rounded-[3rem] overflow-hidden rotate-2 shadow-2xl">
                  <img src="https://images.unsplash.com/photo-1445013517791-41b05179856d?auto=format&fit=crop&q=80&w=800" alt="Synagogue Internal" className="w-full h-full object-cover" referrerPolicy="no-referrer" />
                </div>
                <div className="absolute -top-10 -right-10 bg-gold-warm p-8 rounded-[2.5rem] shadow-2xl text-white max-w-[200px] -rotate-3 border border-white/20">
